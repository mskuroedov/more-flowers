(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define('app', ['@popperjs/core'], factory) :
	...
	var jquery_inputmask_min = createCommonjsModule(function (module, exports) {
	/*!
	...
	unwrapExports(jquery_inputmask_min);
	...
	!function (a, b, c, d) {
	  ...
	  e.Defaults = {
	    ...
	    if ("page" !== g.slideBy && (g.slideBy = Math.min(g.slideBy, g.items)), g.dots || "page" == g.slideBy) for (this._pages = [], a = d, b = 0, 0; a < e; a++) {
	      if (b >= h || 0 === b) {
	        if (this._pages.push({
	...
	(function ($) {
	  $.fn.initCounter = function () {
	    ...
	    $($counterInput).on('change', function () {
	      suffix ? $(this).val(`${value} ${suffix}`) : $(this).val(`${value}`);
	    });
